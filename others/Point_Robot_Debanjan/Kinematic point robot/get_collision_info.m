...
if (q_o(1,1)>=0.5 && q_o(1,1)<1)
    ...
    seg1(1,2) = .5;
    seg1(2,2) = 1;
    dista= (seg1(1,1)*(seg1(2,2)-seg1(2,1)))-(seg1(2,1)*(seg1(1,2)-seg1(1,1)));
